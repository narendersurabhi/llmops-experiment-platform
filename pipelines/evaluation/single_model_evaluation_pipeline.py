...
def evaluate_and_log_single_model_op(
    ...
    return dsl.ContainerSpec(
        ...
        command=["python", "-m", "components.evaluator.run_single_model_evaluation"],
        args=[
            "--eval-config-path",
...
@dsl.pipeline(name="llmops-single-model-evaluation-pipeline")
def single_model_evaluation_pipeline(eval_config_path: str, model_uri: str):
    cfg = resolve_eval_config_op(eval_config_path=eval_config_path)
    _ = set_runtime_env(
        evaluate_and_log_single_model_op(
